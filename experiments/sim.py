...
def simulate(
    ...
    for name, params in envs.items():
        ...
        train_graph = util.make_graph(DR=params["dr"], FA=params["fa"], evaluation=False, sensor_rate=sensor_rate, actuator_rate=actuator_rate, image_rate=image_rate)
        ...
        eval_graph = util.make_graph(DR=params["dr"], FA=params["fa"], evaluation=True, sensor_rate=sensor_rate, actuator_rate=actuator_rate, image_rate=image_rate)
