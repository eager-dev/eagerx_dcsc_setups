...
def evaluate_real(
    ...
    # Define engines
    engine_real_sync = Engine.make("RealEngine", rate=engine_rate, sync=True, process=process.NEW_PROCESS)
    engine_real_async = Engine.make("RealEngine", rate=engine_rate, sync=False, process=process.NEW_PROCESS)
