...
if __name__ == "__main__":
    ...
    for setting in settings:
        ...
        if "domain_randomization" in cfg["settings"][setting] and cfg["settings"][setting]["domain_randomization"]:
            ...
            pendulum.states.mass.space.low = pendulum.states.mass.space.low * 0.9
            pendulum.states.mass.space.high = pendulum.states.mass.space.high * 1.1
            pendulum.states.length.space.low = pendulum.states.length.space.low * 0.9
            pendulum.states.length.space.high = pendulum.states.length.space.high * 1.1
        graph.add(pendulum)
